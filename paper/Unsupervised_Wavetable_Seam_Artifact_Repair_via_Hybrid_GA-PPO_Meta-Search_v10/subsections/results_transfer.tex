...
We do \emph{not} claim a Noise2Noise quality comparison on these transfer boards
(only zero-shot timing appears in Table~\ref{tab:transfer-latency}).
...
($R_{\mathrm{blend}}$ on wavetable boards; prolonged $R$ on this transfer pilot).
