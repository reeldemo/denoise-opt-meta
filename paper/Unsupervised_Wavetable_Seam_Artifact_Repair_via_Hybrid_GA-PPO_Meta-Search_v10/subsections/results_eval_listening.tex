...
Source: \texttt{scripts/bench\_vibrato\_spectrogram.py}; artifacts:
\texttt{brand/artifacts/vibrato\_spectrogram/}.
...
(\texttt{brand/artifacts/meta\_approach\_compare/hear\_samples/}; rebuild via
\texttt{scripts/export\_meta\_hear\_samples.py}).
...
\subsection{Factory and AKWF examples}
