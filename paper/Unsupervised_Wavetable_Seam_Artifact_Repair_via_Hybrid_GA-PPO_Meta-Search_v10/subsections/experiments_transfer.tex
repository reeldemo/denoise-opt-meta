...
Transfer tables are classical-board comparisons under this residual protocol.
Deep diagnosis SOTA and formal listening are out of scope (Section~\ref{sec:limitations}).
