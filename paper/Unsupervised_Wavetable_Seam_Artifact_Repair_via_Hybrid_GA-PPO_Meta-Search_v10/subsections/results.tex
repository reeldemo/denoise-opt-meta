...
\subsection{Hybrid freeze under $R_{\mathrm{blend}}$ and $J$}
...
\paragraph{Historical $5$k whole-curve freeze.}
...
\subsection{Hard cliffs hide DualCosine failure}
...
\subsection{Polynomial baseline and endpoint-pin control}
\label{sec:poly-jump}
...
\subsection{Rust \texttt{sound\_bench} transfer}
