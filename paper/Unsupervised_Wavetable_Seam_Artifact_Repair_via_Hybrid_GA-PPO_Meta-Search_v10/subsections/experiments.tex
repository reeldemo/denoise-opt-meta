...
Evaluation follows \texttt{EVAL\_PROTOCOL.md} in this paper folder (v10.1).
Primary metric: $R_{\mathrm{blend}}$ ($\alpha{=}0.7$). Search objective: $J=R_{\mathrm{blend}}-\lambda\cdot\mathrm{latency\_norm}$ ($\lambda{=}0.02$).
