# DenoiseOpt paper v10.1: LaTeX layout
...
**Protocol (v10.1):** primary $R_{\mathrm{blend}}$ ($\alpha{=}0.7$) + latency objective $J$; Noise2Noise (`SeamN2N`) is the primary neural baseline/gate; DualCosine is classical appendix only. See [`EVAL_PROTOCOL.md`](EVAL_PROTOCOL.md).
