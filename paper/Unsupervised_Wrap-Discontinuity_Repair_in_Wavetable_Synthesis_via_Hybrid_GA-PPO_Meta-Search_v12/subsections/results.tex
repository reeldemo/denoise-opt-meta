...
Plateau boredom in the hybrid loop retunes branch mix when champions stall (Section~\ref{sec:hybrid}).
Near-ceiling residuals yield only a small absolute climb after the first few hundred evaluations.
