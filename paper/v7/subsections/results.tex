...
\begin{figure}[t]
  ...
  \caption{Matched $5$k-budget meta-learning comparison: champion residual $R$ versus outer iteration (x-axis capped at $5{,}000$), including hybrid{+}LSTM/xLSTM. Placeholder until the fresh LSTM{+}xLSTM suite finishes. DualCosine dashed as one classical comparator only---objective is maximize absolute $R$ toward the ideal sibling; rank vs the classical board in Table~\ref{tab:canonical-methods}. Accessibility: Okabe-Ito colors with distinct markers for grayscale print.}
