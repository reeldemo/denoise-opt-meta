...
Scored means remain in Table~\ref{tab:real-wt} and the \href{https://github.com/reeldemo/denoise-opt-meta/blob/master/paper/Unsupervised_Wavetable_Seam_Artifact_Repair_via_Hybrid_GA-PPO_Meta-Search_v11/figures/real_wt_matrix.json}{wavetable results}. This panel is diversity evidence only.
