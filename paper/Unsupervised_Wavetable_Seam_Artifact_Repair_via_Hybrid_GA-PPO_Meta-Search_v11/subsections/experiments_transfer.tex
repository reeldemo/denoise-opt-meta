...
\begin{description}
  ...
  \item[Paderborn KAt (K001).]
    ...
    Deep Paderborn diagnosis models remain unwired (Table~\ref{tab:transfer-sota-status}).
  \item[MIT-BIH ECG.]
...
Deep diagnosis SOTA (Cycle-GAN, BeatDiff, Paderborn deep, \ldots) and formal listening remain out of scope
