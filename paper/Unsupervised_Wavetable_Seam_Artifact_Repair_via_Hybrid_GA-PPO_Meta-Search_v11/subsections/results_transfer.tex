...
\begin{table}[t]
  ...
  \begin{tabular}{@{}lp{0.52\columnwidth}@{}}
    ...
    Scope & Note \\
    \midrule
    Domain-trained Noise2Noise & Scored on seven boards incl.\ Paderborn K001 classical wrap
    ...
    Paderborn KAt deep models & Not run ($K001$ extracted; classical board + domain N2N available; deep unwired) \\
