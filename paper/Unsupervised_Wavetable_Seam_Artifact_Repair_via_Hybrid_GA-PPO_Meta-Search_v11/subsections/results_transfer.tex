...
\begin{table*}[t]
  ...
  \begin{tabular}{@{}lrrrrrr@{}}
    ...
    \midrule
    Ours (\texttt{hybrid\_lstm}) & 0.9623 & 0.9411 & 0.9565 & 0.9379 & 0.9918 & 0.9915 \\
    Domain N2N & 0.8686 & 0.8817 & 0.6530 & 0.5702 & 0.4833 & 0.9789 \\
    no-bake & 0.8451 & 0.8657 & 0.7495 & 0.7617 & 0.4499 & 0.9356 \\
    endpoint-pin & 0.5054 & 0.5446 & 0.8650 & 0.8696 & 0.4096 & 0.9442 \\
    \texttt{seam\_fir3} & 0.4483 & 0.5726 & 0.7662 & 0.7604 & 0.5344 & 0.9119 \\
    DualCosine & 0.4608 & 0.4830 & 0.4137 & 0.5118 & 0.4943 & 0.8272 \\
    \bottomrule
  \end{tabular}
\end{table*}
...
\begin{table}[t]
  ...
  \begin{tabular}{@{}lp{0.52\columnwidth}@{}}
    ...
    Scope & Note \\
    \midrule
    Domain-trained Noise2Noise & Scored on seven boards incl.\ Paderborn K001
      (holdout prolonged $R$; six-board Table~\ref{tab:transfer-main}; Paderborn N2N $R{=}0.8387$;
      expanded PTB-XL N2N $R{=}0.5702$) \\
    Cycle-GAN (ECG) & OOD wrap-$R$ scored (MIT-BIH $R{=}0.0700$; PTB-XL $R{=}0.1480$);
      clinical restore $\neq$ wrap-$R$ \\
    BeatDiff & Not run (no usable diffusion checkpoint) \\
    Paderborn KAt deep models & Deep unwired; classical board + full Ours ($R{=}0.9270$, $250$ iters)
      + domain N2N available \\
...
On the Paderborn K001 classical wrap board, full-protocol Ours ($250$ iters) reaches $R{=}0.9270$
(vs domain N2N $0.8387$; smoke $20$-iter run was $0.8932$ and is not used as the protocol number).
An Operational Cycle-GAN checkpoint loads and scores under wrap-$R$, but the OOD probe collapses
($R{\approx}0.07$--$0.15$)---clinical ECG restore is not the wrap residual objective.
