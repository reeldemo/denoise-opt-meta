...
At the completed gate, Ours leads on absolute champion $R$ ($R{\approx}0.99146$, $\Delta R{\approx}{+}0.17488$ vs Dual Cosine ${\approx}0.81658$, ${\approx}8.46$\,h). Aging evolution is second ($R{\approx}0.99079$).
