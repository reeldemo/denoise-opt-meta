...
\begin{itemize}
  ...
  \item \textbf{Outer loop} / \textbf{meta-search}: GA--PPO search over repair-operator graphs (not end-to-end training of one large network).
...
All main-text claims, tables, and figures use the locked v10.1 $R_{\mathrm{blend}}$ protocol (Section~\ref{sec:residual-score}).
