...
Only seed~\texttt{1902771841} hybrid clears the frozen Noise2Noise gate ($R_{\mathrm{blend}}{\approx}0.9766$ vs gate ${\approx}0.9750$).
...
\begin{figure}[t]
  ...
  \caption{Champion $R_{\mathrm{blend}}$ over a matched 5,000-evaluation budget (Deferred D1; seed \texttt{1902771841}).
