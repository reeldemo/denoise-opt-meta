...
\begin{itemize}
  \item On the primary holdout, the hybrid champion sits just below the frozen Noise2Noise gate on every seed ($0.971{\pm}0.001$ vs $0.977{\pm}0.001$) and well above Dual Cosine ($0.542{\pm}0.038$).
  \item On twenty multi-family boards, Ours mean-of-means edges Noise2Noise ($0.934{\pm}0.003$ vs $0.931{\pm}0.005$; mean win fraction $0.47$ across seeds).
