...
\begin{table}[t]
  ...
  \caption{Parameter-count fairness under the locked holdout story.
    ...
    Holdout scores are mean$\pm$std over five evaluation seeds.}
  ...
  \begin{tabular}{@{}lrr@{}}
    ...
    \midrule
    Favorite $\Theta$ (v10.1 hybrid) & ${\approx}121$k & $0.9708{\pm}0.0014$ \\
    SeamN2N (corrupt$\to$corrupt) & ${\approx}53.5$k & $0.9767{\pm}0.0015$ \\
