...
\begin{figure*}[t]
  ...
  \caption{Sine-wrap modulation edge case from the canonical eval holdout (same tile). Ideal reference, cliff-modulated engine (ideal overlay), DualCosine bake, and top meta favorite ($R\approx0.9917$ on this tile, batch mean $R\approx0.991$). Bottom: modulation residual and seam zoom. Prolonged residual $R$ is printed per panel.}
...
\begin{enumerate}
  ...
  \item \textbf{Literature protocol.} Separate used versus screened prior work for audio denoise cells and RL--evolutionary hybrids, grounded on downloaded source PDFs.
