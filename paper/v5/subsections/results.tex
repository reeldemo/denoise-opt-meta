...
\paragraph{Classical vs AI (canonical holdout).}
...
\begin{table}[t]
  \centering
  \caption{Method scores on the canonical sine{+}cliff holdout (batch 64, seed $20{,}260{,}719$). Mean$\pm$std over five consecutive seeds. Identity is a no-op ceiling.}
...
\begin{figure}[t]
  ...
  \caption{Canonical holdout: classical bake denoisers vs neural favorite ($R$ vs CUDA ms/batch). Red star: AI favorite.}
...
\begin{figure}[t]
  ...
  \caption{Canonical holdout ranking on residual (left) and latency (right). AI in red. DualCosine $R\approx 0.825$.}
