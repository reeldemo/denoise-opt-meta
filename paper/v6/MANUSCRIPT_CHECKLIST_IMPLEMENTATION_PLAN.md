...
**Artifact:** `paper/v6/main.tex` + `subsections/*.tex` → `main.pdf`  
...
0.1 Rebuild `paper/v6/main.pdf` from current tex; spot-check TOC/sections against checklist 2.3–2.8.  
...
**Acceptance:** Written triage counts match this plan; protocol freeze checked into `paper/v6/` (this file + optional `EVAL_PROTOCOL.md`).
...
- `paper/v6/main.tex` (title, abstract, keywords, `\papershorttitle`, author affiliation)  
- `paper/v6/TITLES.md`  
- `paper/v6/subsections/introduction.tex` (contribution bullets + claim language)  
- `paper/v6/subsections/conclusion.tex` (sync)
...
Target file: `paper/v6/subsections/methods.tex` (may split into `methods_*.tex` if length warrants).
...
- `paper/v6/regen_overnight_figures.ps1` — keep for convergence figs.
...
- `reelsynth/scripts/plot_sota_matrix.py` → `paper/v6/figures/fig_sota_heatmap.png` (+ colorblind palette)  
- Sync JSON/PNG into `denoise-opt-meta/paper/v6/figures/`
...
6.3 Sync mirror: `reelsynth/docs/papers/denoise_opt/v6/` (tex + this plan + key figures).  
