...
> **Canonical path:** `denoise-opt-meta/paper/v6/WEAKNESS_ELIMINATION_PLAN.md`  
...
**Tech Stack:** Same as prior plan — `reelsynth/scripts/` benches (local, uncommitted by default), TeX + JSON under `denoise-opt-meta/paper/v6/` (commit/push **only** here).
...
- Update: `denoise-opt-meta/paper/v6/figures/real_wt_matrix.json`
- Update: `denoise-opt-meta/paper/v6/SAMPLE_LICENSES.md`
...
- Create: `denoise-opt-meta/paper/v6/figures/poly_baseline.json`
...
- Create: `denoise-opt-meta/paper/v6/figures/transfer_failures.json`
...
| G7 | Artifacts under `paper/v6/` updated; `WEAKNESS_ELIMINATION_COMPLETE.flag` written; commit+push **denoise-opt-meta only**. |
...
| `denoise-opt-meta/paper/v6/figures/real_wt_matrix.json` | Realism freeze |
| `denoise-opt-meta/paper/v6/figures/poly_baseline.json` | Poly freeze |
| `denoise-opt-meta/paper/v6/figures/transfer_failures.json` | Transfer freeze |
| `denoise-opt-meta/paper/v6/SAMPLE_LICENSES.md` | True licenses + URLs |
| `denoise-opt-meta/paper/v6/EVAL_PROTOCOL.md` | Edge RMSE lock |
| `denoise-opt-meta/paper/v6/subsections/{results,discussion,limitations,experiments}.tex` | Manuscript |
| `denoise-opt-meta/paper/v6/WEAKNESS_ELIMINATION_COMPLETE.flag` | Completion marker |
...
`denoise-opt-meta/paper/v6/WEAKNESS_ELIMINATION_PLAN.md`
