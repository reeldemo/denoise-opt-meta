...
Evaluation follows \texttt{paper/v6/EVAL\_PROTOCOL.md} (v1, extended for peer-review strata).
Primary metric: prolonged $R$. Secondary: SNR, SDR, wrap-jump, and seam-local edge RMSE on tiled audio.
...
No overnight champion weights initialize those baselines.
...
Wavetable-native transfer (Phase~C) scores ReelSynth-style factory periods (primary realism) and OA additive-harmonic instrument one-shots (secondary) under the same close-seam$\to$open-wrap protocol.
