...
**Tech Stack:** Python/PyTorch benches in `reelsynth/scripts/`; Rust `sound_bench` + `export_sound_bench_tiles`; paper TeX in `denoise-opt-meta/paper/v6/` mirrored to `reelsynth/docs/papers/denoise_opt/v6/`.

**Canonical plan path:** `denoise-opt-meta/paper/v6/PEER_REVIEW_IMPROVEMENT_PLAN.md`  
**Mirror (local only for this workstream):** `reelsynth/docs/papers/denoise_opt/v6/PEER_REVIEW_IMPROVEMENT_PLAN.md`  
...
| `denoise-opt-meta/paper/v6/subsections/methods.tex` | Props/Lemma/$R$ definition |
| `denoise-opt-meta/paper/v6/subsections/experiments.tex` | Protocol, dataset |
| `denoise-opt-meta/paper/v6/subsections/results.tex` | Tables, strata |
| `denoise-opt-meta/paper/v6/subsections/discussion.tex` | Identity-$R$ / hard-cliff narrative |
| `denoise-opt-meta/paper/v6/subsections/limitations.tex` | Scope honesty |
| `denoise-opt-meta/paper/v6/subsections/related_work.tex` | N2N contrast |
| `denoise-opt-meta/paper/v6/main.tex` | Abstract / keywords |
| `denoise-opt-meta/paper/v6/EVAL_PROTOCOL.md` | Frozen protocol extension |
| `denoise-opt-meta/paper/v6/figures/*.json` | Regenerated figure/table blobs |
| Mirror tree | `reelsynth/docs/papers/denoise_opt/v6/` (sync tex + this plan) |
...
- Create: `denoise-opt-meta/paper/v6/figures/cliff_strata.json`
- Mirror copy of JSON under `reelsynth/docs/papers/denoise_opt/v6/figures/`
...
- Modify: `denoise-opt-meta/paper/v6/EVAL_PROTOCOL.md`
...
**Files:**
- Modify: `denoise-opt-meta/paper/v6/subsections/results.tex`
- Modify: `denoise-opt-meta/paper/v6/subsections/discussion.tex`
- Modify: `denoise-opt-meta/paper/v6/subsections/experiments.tex`
- Modify: `denoise-opt-meta/paper/v6/main.tex` (abstract hard-cliff clause once numbers land)
- Sync mirror tex
...
- Create: `denoise-opt-meta/paper/v6/figures/n2n_baseline.json`
...
**Files:**
- Modify: `denoise-opt-meta/paper/v6/subsections/related_work.tex`
- Modify: `denoise-opt-meta/paper/v6/subsections/experiments.tex`
- Modify: `denoise-opt-meta/paper/v6/subsections/limitations.tex`
...
- Create: `denoise-opt-meta/paper/v6/figures/real_wt_matrix.json`
...
**Files:**
- Create: `denoise-opt-meta/paper/v6/SAMPLE_LICENSES.md`
...
**Files:**
- Modify: `denoise-opt-meta/paper/v6/subsections/methods.tex`
- Optional create: `denoise-opt-meta/paper/v6/subsections/appendix_immediate.tex` (if venue allows appendix; prefer deletion over appendix theater)
...
- [ ] Canonical plan lives under `denoise-opt-meta/paper/v6/` (reelsynth mirror optional/local-only unless user asks to commit).
...
- `denoise-opt-meta/paper/v6/PEER_REVIEW_IMPROVEMENT_PLAN.md` (**canonical; commit/push here only**)
- `reelsynth/docs/papers/denoise_opt/v6/PEER_REVIEW_IMPROVEMENT_PLAN.md` (optional local mirror; **do not commit** unless user asks)
